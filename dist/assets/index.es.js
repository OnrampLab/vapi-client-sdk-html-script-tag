...
var U = (n, e, t) => (Ka(n, typeof e != "symbol" ? e + "" : e, t), t);
var Ll = Qa((Il, Ja) => {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function Lr(n, e, t, r) {
    var i, a, c, l;
    if (Dt(t), (a = n._events) === void 0 ? (a = n._events = /* @__PURE__ */ Object.create(null), n._eventsCount = 0) : (a.newListener !== void 0 && (n.emit("newListener", e, t.listener ? t.listener : t), a = n._events), c = a[e]), c === void 0)
  ...
  function Ir(n, e, t) {
    ...
    return i === void 0 ? [] : typeof i == "function" ? t ? [i.listener || i] : [i] : t ? function(a) {
      for (var c = new Array(a.length), l = 0; l < c.length; ++l)
        c[l] = a[l].listener || a[l];
      return c;
    }(i) : to(i, i.length);
  }
  function Dr(n) {
  ...
  class _ {
    ...
    static compareVersions(e, t, r = !1) {
      const i = _.getVersionPrecision(e), a = _.getVersionPrecision(t);
  ...
  class jr {
    ...
    isBrowser(e, t = !1) {
      ...
      let i = e.toLowerCase();
      const a = _.getBrowserTypeByAlias(i);
    ...
    compareVersion(e) {
      ...
      if (typeof a == "string")
        return e[0] === ">" || e[0] === "<" ? (r = e.substr(1), e[1] === "=" ? (i = !0, r = e.substr(2)) : t = [], e[0] === ">" ? t.push(1) : t.push(-1)) : e[0] === "=" ? r = e.substr(1) : e[0] === "~" && (i = !0, r = e.substr(1)), t.indexOf(_.compareVersions(a, r, i)) > -1;
    }
    isOS(e) {
  ...
  function cs(n, e, t = 250, r, i, a, c) {
    if (!(a.exception && a.exception.values && c && Ye(c.originalException, Error)))
      return;
  ...
  function wn(n, e = {}) {
    try {
      ...
      for (; t && a++ < r && (h = ds(t, p), !(h === "html" || a > 1 && c + i.length * u + h.length >= m)); )
      ...
      switch (Wr[n] = !0, n) {
        ...
        case "xhr":
          (function() {
            ...
            W(e, "open", function(t) {
              return function(...r) {
                const i = r[1], a = this[ut] = { method: Ve(r[0]) ? r[0].toUpperCase() : r[0], url: r[1], request_headers: {} };
                Ve(i) && a.method === "POST" && i.match(/sentry_key/) && (this.__sentry_own_request__ = !0);
                const c = () => {
                  const l = this[ut];
        ...
        case "history":
          (function() {
            ...
            B.onpopstate = function(...r) {
              ...
              if (Ct = i, oe("history", { from: a, to: i }), e)
                try {
...
`), typeof u == "string" || u instanceof Uint8Array)
  ...
  const ws = { session: "session", sessions: "session", attachment: "attachment", transaction: "transaction", event: "error", client_report: "internal", user_report: "default", profile: "profile", replay_event: "replay", replay_recording: "replay", check_in: "monitor" };
  function Zr(n) {
    return ws[n];
  }
  function mo(n) {
    ...
    sendEvent(e, t = {}) {
      if (this._dsn) {
        ...
        for (const a of t.attachments || [])
          r = ys(r, Ss(a, this._options.transportOptions && this._options.transportOptions.textEncoder));
    ...
    _processEvent(e, t, r) {
      ...
      return this._prepareEvent(e, t, r).then((m) => {
        ...
        const y = function(w, b, S) {
          ...
          return ai(b) && T ? T(b, S) : si(b) && O ? O(b, S) : b;
        }(i, m, t);
        return function(w, b) {
...
Url: ${Lt(p)}`), !0);
  ...
  function rr(n, e, t, r, i) {
    ...
    return oo(e) ? hn(n, e) : tt(e) || Gt(e) ? (a = function(c, l, u, h) {
      const p = te().getClient(), m = p && p.getOptions().normalizeDepth, y = { exception: { values: [{ type: Gt(l) ? l.constructor.name : h ? "UnhandledRejection" : "Error", value: Fs(l, { isUnhandledRejection: h }) }] }, extra: { __serialized__: ho(l, m) } };
      if (u) {
        const w = nr(c, u);
        w.length && (y.exception.values[0].stacktrace = { frames: w });
      }
      return y;
    }(n, e, t, i), gt(a, { synthetic: !0 }), a) : (a = In(n, e, t, r), Cn(a, `${e}`, void 0), gt(a, { synthetic: !0 }), a);
  }
  function In(n, e, t, r) {
    const i = { message: e };
    if (r && t) {
  ...
  class yt {
    ...
    setupOnce() {
      this.options.console && xe("console", Bs), this.options.dom && xe("dom", /* @__PURE__ */ function(e) {
        function t(r) {
          ...
          try {
            ...
            i = function(u) {
              return !!u && !!u.target;
            }(l) ? wn(l.target, { keyAttrs: a, maxStringLength: c }) : wn(l, { keyAttrs: a, maxStringLength: c });
          } catch {
            i = "<unknown>";
          }
        ...
        return t;
      }(this.options.dom)), this.options.xhr && xe("xhr", Us), this.options.fetch && xe("fetch", Vs), this.options.history && xe("history", Ys);
    }
  ...
  class $s extends je {
    ...
    eventFromException(e, t) {
      return function(r, i, a, c) {
        ...
        return gt(l), l.level = "error", a && a.event_id && (l.event_id = a.event_id), $e(l);
  ...
  function Js() {
    xe("unhandledrejection", (n) => {
      ...
      a.level = "error", Eo(e, i, a, "onunhandledrejection");
    });
  }
  function hi(n, e, t, r) {
    const i = n.exception = n.exception || {}, a = i.values = i.values || [], c = a[0] = a[0] || {}, l = c.stacktrace = c.stacktrace || {}, u = l.frames = l.frames || [], h = isNaN(parseInt(r, 10)) ? void 0 : r, p = isNaN(parseInt(t, 10)) ? void 0 : t, m = Ve(e) && e.length > 0 ? e : function() {
      try {
  ...
  function fi(n, e) {
    ...
    for (let i = 0; i < r.length; i++) {
      const a = r[i], c = t[i];
      if (a.filename !== c.filename || a.lineno !== c.lineno || a.colno !== c.colno || a.function !== c.function)
        return !1;
    }
    return !0;
  }
  ...
  var xc = function() {
    ...
    return ue(n, [{ key: "start", value: (i = M(function* () {
      ...
      if (this._iosCache && c.status === 304)
        return (yield this._iosCache.renew(a, c.headers)).code;
  ...
  function Ii(n, e) {
    for (var t = e.getState(), r = 0, i = ["cam", "screen"]; r < i.length; r++)
      for (var a = i[r], c = 0, l = ["video", "audio"]; c < l.length; c++) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var Ui = "video", nl = "voice", Vi = N() ? { data: {} } : { data: {}, topology: "none" }, Yi = { present: 0, hidden: 0 }, Ca = { maxBitrate: { min: 1e5, max: 25e5 }, maxFramerate: { min: 1, max: 30 }, scaleResolutionDownBy: { min: 1, max: 8 } }, vn = Object.keys(Ca), $i = ["state", "volume", "simulcastEncodings"], Gi = { androidInCallNotification: { title: "string", subtitle: "string", iconName: "string", disableForCustomOverride: "boolean" }, disableAutoDeviceManagement: { audio: "boolean", video: "boolean" } }, Qt = { id: { iconPath: "string", iconPathDarkMode: "string", label: "string", tooltip: "string" } }, Wn = { id: { allow: "string", controlledBy: "'*' | 'owners' | string[]", csp: "string", iconURL: "string", label: "string", loading: "'eager' | 'lazy'", location: "'main' | 'sidebar'", name: "string", referrerPolicy: "string", sandbox: "string", src: "string", srcdoc: "string", shared: "string[] | 'owners' | boolean" } }, Ie = { customIntegrations: { validate: Na, help: Ia() }, customTrayButtons: { validate: Da, help: "customTrayButtons should be a dictionary of the type ".concat(JSON.stringify(Qt)) }, url: { validate: function(n) {
    ...
    for (var e = 0, t = Object.entries(n); e < t.length; e++) {
      ...
      switch (i) {
        ...
        case "canAdmin":
          if (a instanceof Set || a instanceof Array) {
            var p, m = ["participants", "streaming", "transcription"], y = Fi(a);
            try {
              for (y.s(); !(p = y.n()).done; ) {
                var w = p.value;
                if (!m.includes(w))
  ...
  var rl = function(n) {
    Xt(ne, be);
    var e, t, r, i, a, c, l, u, h, p, m, y, w, b, S, T, O, $, Se, Ge, ot, cr, lr, ur, dr, hr, pr, fr, mr, gr, vr, _r, yr, br, Sr, wr, Wa = tl(ne);
    function ne(o) {
      var s, d, f = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      if (le(this, ne), Ee(ge(s = Wa.call(this)), "startListeningForDeviceChanges", function() {
        zc(s.handleDeviceChange);
      }), Ee(ge(s), "stopListeningForDeviceChanges", function() {
        Hc(s.handleDeviceChange);
      }), Ee(ge(s), "handleDeviceChange", function(v) {
        v = v.map(function(E) {
          return JSON.parse(JSON.stringify(E));
        }), s.emit(Si, { action: Si, availableDevices: v });
      }), Ee(ge(s), "handleNativeAppStateChange", function() {
        var v = M(function* (E) {
          if (E === "destroyed")
            return console.warn("App has been destroyed before leaving the meeting. Cleaning up all the resources!"), void (yield s.destroy());
          var k = E === "active";
      ...
      }()), Ee(ge(s), "handleNativeAudioFocusChange", function(v) {
      ...
      }), Ee(ge(s), "handleNativeSystemScreenCaptureStop", function() {
        s.stopScreenShare();
      }), s.strictMode = f.strictMode === void 0 || f.strictMode, he) {
        if (s._logDuplicateInstanceAttempt(), s.strictMode)
      ...
      if (window._daily || (window._daily = { pendings: [], instances: {} }), s._callFrameId = en(), window._daily.instances[s._callFrameId] = {}, s._sharedTracks = {}, window._daily.instances[s._callFrameId].tracks = s._sharedTracks, f.dailyJsVersion = ne.version(), s._iframe = o, s._callObjectMode = f.layout === "none" && !s._iframe, s._preloadCache = { subscribeToTracksAutomatically: !0, audioDeviceId: null, videoDeviceId: null, outputDeviceId: null, inputSettings: null, sendSettings: null, videoTrackForNetworkConnectivityTest: null, videoTrackForConnectionQualityTest: null }, f.showLocalVideo !== void 0 ? s._callObjectMode ? console.error("showLocalVideo is not available in call object mode") : s._showLocalVideo = !!f.showLocalVideo : s._showLocalVideo = !0, f.showParticipantsBar !== void 0 ? s._callObjectMode ? console.error("showParticipantsBar is not available in call object mode") : s._showParticipantsBar = !!f.showParticipantsBar : s._showParticipantsBar = !0, f.customIntegrations !== void 0 ? s._callObjectMode ? console.error("customIntegrations is not available in call object mode") : s._customIntegrations = f.customIntegrations : s._customIntegrations = {}, f.customTrayButtons !== void 0 ? s._callObjectMode ? console.error("customTrayButtons is not available in call object mode") : s._customTrayButtons = f.customTrayButtons : s._customTrayButtons = {}, f.activeSpeakerMode !== void 0 ? s._callObjectMode ? console.error("activeSpeakerMode is not available in call object mode") : s._activeSpeakerMode = !!f.activeSpeakerMode : s._activeSpeakerMode = !1, f.receiveSettings ? s._callObjectMode ? s._receiveSettings = f.receiveSettings : console.error("receiveSettings is only available in call object mode") : s._receiveSettings = {}, s.validateProperties(f), s.properties = A({}, f), s._preloadCache.inputSettings || (s._preloadCache.inputSettings = {}), f.inputSettings && f.inputSettings.audio && (s._preloadCache.inputSettings.audio = f.inputSettings.audio), f.inputSettings && f.inputSettings.video && (s._preloadCache.inputSettings.video = f.inputSettings.video), s._callObjectLoader = s._callObjectMode ? new xc(s._callFrameId) : null, s._callState = Dn, s._isPreparingToJoin = !1, s._accessState = { access: Nt }, s._meetingSessionSummary = {}, s._finalSummaryOfPrevSession = {}, s._meetingSessionState = yn(Vi, s._callObjectMode), s._nativeInCallAudioMode = Ui, s._participants = {}, s._isScreenSharing = !1, s._participantCounts = Yi, s._rmpPlayerState = {}, s._waitingParticipants = {}, s._network = { threshold: "good", quality: 100 }, s._activeSpeaker = {}, s._localAudioLevel = 0, s._remoteParticipantsAudioLevel = {}, s._messageChannel = N() ? new Dc() : new Pc(), s._iframe && (s._iframe.requestFullscreen ? s._iframe.addEventListener("fullscreenchange", function() {
        document.fullscreenElement === s._iframe ? (s.emit(Ne, { action: Ne }), s.sendMessageToCallMachine({ action: Ne })) : (s.emit(Re, { action: Re }), s.sendMessageToCallMachine({ action: Re }));
      }) : s._iframe.webkitRequestFullscreen && s._iframe.addEventListener("webkitfullscreenchange", function() {
        document.webkitFullscreenElement === s._iframe ? (s.emit(Ne, { action: Ne }), s.sendMessageToCallMachine({ action: Ne })) : (s.emit(Re, { action: Re }), s.sendMessageToCallMachine({ action: Re }));
      })), N()) {
        var g = s.nativeUtils();
    ...
    return ue(ne, [{ key: "destroy", value: (wr = M(function* () {
      ...
      for (var d in s) {
        ...
        if (It[d].validate && !It[d].validate(s[d], this, this._participants[o]))
      ...
      for (var d in o)
        d === s && (d = "local"), d && o[d] && this.validateParticipantProperties(d, o[d]);
      ...
      if (pe(this._callObjectMode, "updateWaitingParticipant()"), Y(this._callState, "updateWaitingParticipant()"), typeof s != "string" || F(d) !== "object")
      ...
      if (pe(this._callObjectMode, "updateWaitingParticipants()"), Y(this._callState, "updateWaitingParticipants()"), F(s) !== "object")
      ...
      var s = this;
      if (pe(this._callObjectMode, "updateReceiveSettings()"), !Aa(o, { allowAllParticipantsKey: !0 }))
      ...
      var o, s, d, f, g, v, E, k, P = { processor: { type: "none", _isDefaultWhenNone: !0 } };
      this._inputSettings ? (o = ((d = this._inputSettings) === null || d === void 0 ? void 0 : d.video) || P, s = ((f = this._inputSettings) === null || f === void 0 ? void 0 : f.audio) || P) : (o = ((g = this._preloadCache) === null || g === void 0 || (v = g.inputSettings) === null || v === void 0 ? void 0 : v.video) || P, s = ((E = this._preloadCache) === null || E === void 0 || (k = E.inputSettings) === null || k === void 0 ? void 0 : k.audio) || P);
      ...
      if (I(), this._callMachineInitialized)
        return this.sendMessageToCallMachine({ action: "set-bandwidth", kbs: s, trackConstraints: d }), this;
      ...
      if (s && s !== "music" && s !== "speech" && !(s instanceof Object))
      ...
      return I(), g !== void 0 && (d = g), v !== void 0 && (f = v), d && (this._preloadCache.audioDeviceId = d, this._sharedTracks.audioDeviceId = d), f && (this._preloadCache.videoDeviceId = f, this._sharedTracks.videoDeviceId = f), this._callObjectMode && this.needsLoad() ? { camera: { deviceId: this._preloadCache.videoDeviceId }, mic: { deviceId: this._preloadCache.audioDeviceId }, speaker: { deviceId: this._preloadCache.outputDeviceId } } : (d instanceof MediaStreamTrack && (d = dt), f instanceof MediaStreamTrack && (f = dt), new Promise(function(E) {
        s.sendMessageToCallMachine({ action: "set-input-devices", audioDeviceId: d, videoDeviceId: f }, function(k) {
          delete k.action, delete k.callbackStamp, k.returnPreloadCache ? E({ camera: { deviceId: s._preloadCache.videoDeviceId }, mic: { deviceId: s._preloadCache.audioDeviceId }, speaker: { deviceId: s._preloadCache.outputDeviceId } }) : E(k);
        });
      }));
    }), function(o) {
      ...
      var o = this, s = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      if (pe(this._callObjectMode, "preAuth()"), qi(this._callState, this._isPreparingToJoin, "preAuth()"), De(this._testCallInProgress, "preAuth()"), this.needsLoad() && (yield this.load(s)), !s.url)
      ...
      if (this.needsLoad()) {
        ...
        return this._callObjectMode ? new Promise(function(d, f) {
          ...
          s._callObjectLoader.load(s.properties.dailyConfig, function(v) {
            ...
            if (s.emit(xn, { action: xn, error: v }), !E) {
      ...
      if (this.needsLoad()) {
        ...
        if (s.url && !this._callObjectMode && s.url && s.url !== this.properties.url)
          return console.error("url in join() is different than the one used in load() (".concat(this.properties.url, " -> ").concat(s.url, ")")), this.updateIsPreparingToJoin(!1), Promise.reject();
        this.validateProperties(s), this.properties = A(A({}, this.properties), s);
      }
      if (s.showLocalVideo !== void 0 && (this._callObjectMode ? console.error("showLocalVideo is not available in callObject mode") : this._showLocalVideo = !!s.showLocalVideo), s.showParticipantsBar !== void 0 && (this._callObjectMode ? console.error("showParticipantsBar is not available in callObject mode") : this._showParticipantsBar = !!s.showParticipantsBar), this._callState === Fe || this._callState === Ht)
      ...
      var o = this;
      return De(this._testCallInProgress, "leave()"), new Promise(function(s) {
        if (o._callState === ve || o._callState === _e)
          ...
          o._resolveLeave = s, o.sendMessageToCallMachine({ action: "leave-meeting" });
      });
    }), function() {
      ...
      if (_n(this._callMachineInitialized, "startScreenShare()"), s.screenVideoSendSettings && this._validateVideoSendSettings("screenVideo", s.screenVideoSendSettings), s.mediaStream && (this._sharedTracks.screenMediaStream = s.mediaStream, s.mediaStream = dt), typeof DailyNativeUtils < "u" && DailyNativeUtils.isIOS !== void 0 && DailyNativeUtils.isIOS) {
        ...
        d.setSystemScreenCaptureStartCallback(function() {
          d.setSystemScreenCaptureStartCallback(null), o.sendMessageToCallMachine({ action: Ei, captureOptions: s });
        }), d.presentSystemScreenCapturePrompt();
      } else
        this.sendMessageToCallMachine({ action: Ei, captureOptions: s });
    }), function() {
  ...
  { settings?: {state: "play"|"pause"} }`), g;
      ...
      return new Promise(function(g, v) {
        s.sendMessageToCallMachine({ action: "daily-method-update-remote-media-player", session_id: d, settings: f }, function(E) {
      ...
      var o = this;
      return this._callState !== Fe ? { stats: { latest: {} } } : new Promise(function(s) {
      ...
      return this._sharedTracks.videoTrackForConnectionQualityTest = d, new Promise(function(g, v) {
        s.sendMessageToCallMachine({ action: "test-p2p-call-quality", duration: f }, function(E) {
      ...
      var s;
      if (!(((s = Object.keys(o)) === null || s === void 0 ? void 0 : s.length) > 0))
      ...
      if (this._callObjectMode) {
        ...
        return Le() === "Firefox" && Yn().major > 115 && Yn().major < 123 && (s = s.filter(function(d) {
      ...
      for (var s in o) {
        if (!Ie[s])
          throw new Error("unrecognized property '".concat(s, "'"));
        if (Ie[s].validate && !Ie[s].validate(o[s], this))
          throw new Error("property '".concat(s, "': ").concat(Ie[s].help));
      }
      ...
      switch (o.action) {
        ...
        case _a:
          if (!Z(this._inputSettings, o.inputSettings)) {
            ...
            if (this._inputSettings = o.inputSettings, this._preloadCache.inputSettings = {}, !Z(an, this._getInputSettings()))
              try {
      ...
      if (o && (o.readyState === "ended" || !s || o.id !== s.id))
        try {
      ...
      if (s && (!o || o.readyState === "ended" || s.id !== o.id))
        try {
      ...
      if (o)
        for (var d in o.tracks)
          this.maybeEventTrackStopped(o.tracks[d].track, s && s.tracks[d] ? s.tracks[d].track : null, s, d);
    } }, { key: "maybeParticipantTracksStarted", value: function(o, s) {
      if (s)
        for (var d in s.tracks)
          this.maybeEventTrackStarted(o && o.tracks[d] ? o.tracks[d].track : null, s.tracks[d].track, s, d);
      ...
      return { supported: !!Mi(), mobile: o.getPlatformType() === "mobile", name: o.getBrowserName(), version: o.getBrowserVersion(), supportsFullscreen: !!Ci(), supportsScreenShare: !!Mc(), supportsSfu: !!Mi(), supportsVideoProcessing: Sa(), supportsAudioProcessing: wa() };
  ...
  function La(n, e) {
    var t, r = [];
    n.video && !Sa((t = e == null ? void 0 : e.useLegacyVideoProcessor) !== null && t !== void 0 && t) && (delete n.video, r.push("video")), n.audio && !wa() && (delete n.audio, r.push("audio")), r.length > 0 && console.error("Ignoring settings for browser- or platform-unsupported input processor(s): ".concat(r.join(", ")));
  }
  function zn() {
  ...
  class Ga {
    constructor(e = {}) {
      ...
      U(this, "request", async ({ body: e, secure: t, path: r, type: i, query: a, format: c, baseUrl: l, cancelToken: u, ...h }) => {
        const p = (typeof t == "boolean" ? t : this.baseApiParams.secure) && this.securityWorker && await this.securityWorker(this.securityData) || {}, m = this.mergeRequestParams(h, p), y = a && this.toQueryString(a), w = this.contentFormatters[i || V.Json], b = c || m.format;
  ...
  function Al(n, e, t, r, i, a) {
    let c = !1;
    const l = () => {
      a(e, "loading"), c ? (n.stop(), c = !1) : (t || r ? n.start(t, r).then((u) => {
        window.currentCall = u;
      }) : (console.log("squad ,", i, t, r), n.start(void 0, void 0, i).then((u) => {
        window.currentCall = u;
      })), c = !0);
    };
    n.on("call-start", () => {
